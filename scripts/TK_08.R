...
#' 
#' Today we will make a copy of a template for your final project, edit it, and 'push' it back up to your github account.  You can check out the template code at [https://github.com/AdamWilsonLabEDU/geo511_project](https://github.com/AdamWilsonLabEDU/geo511_project) and the template website at [https://adamwilsonlabedu.github.io/geo511_project/](https://adamwilsonlabedu.github.io/geo511_project/)
#' 
#' ## R Markdown
#' 
#' Cheatsheet:
