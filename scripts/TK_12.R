...
#' 
#' 1. Browse the [current drafts of projects here](https://github.com/geo511-2021?q=project&type=&language=).  
...
#' 
#' 1) Explore the final projects in the [class repository](https://github.com/geo511-2021?q=project&type=&language=)
...
#' 3) Browse the project website (should be linked in the upper right corner of the repository page on GitHub).
