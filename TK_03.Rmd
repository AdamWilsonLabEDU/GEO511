...
reading:
  ...
  - Chapters [4-8 in Happy Git and Github for the useR - Installation](https://happygitwithr.com/install-intro.html){target='blank'}
...
tasks:
  ...
  - Click on [this link to access the course repository](https://classroom.github.com/a/8LE9CtTz)
  ...
  - You may need to set up SSH keys to push your commit.
  ...
  - Copy the contents of your scripts from previous weeks into the appropriate file (but don't edit the file name!)
---
