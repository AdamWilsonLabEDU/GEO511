...
```{r download_data2, eval=F, echo=T, purl=F, warning=F}
...
```{r, echo=F, eval=F, purl=F, warning=F}
...
```{r, echo=F, eval=F, purl=F, warning=F, fig.width=15, fig.height=15}
map1=ggplot() +
  geom_sf(data=world,
...
```{r, eval=F, echo=F, purl=F, warning=F, message=F}
...
```{r, eval=F, echo=F, purl=F, fig.height=10,fig.width=10}
